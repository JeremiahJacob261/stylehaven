...
export function BalenciagaReceiptForm({ data, onInputChange }: BalenciagaReceiptFormProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Product Colour</label>
            <input 
              type="text" 
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i}>
              ...
              <input 
                ...
                onChange={(e) => onInputChange(`ADDRESS${i}` as keyof BalenciagaReceiptData, e.target.value)} 
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          ))}
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i}>
              ...
              <input 
                ...
                onChange={(e) => onInputChange(`BILLING${i}` as keyof BalenciagaReceiptData, e.target.value)} 
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          ))}
