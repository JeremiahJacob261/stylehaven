    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Customer Name (WHOLE_NAME)</label>
            <input 
              type="text" 
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input 
              ...
              onChange={(e) => onInputChange('PRODUCT_REFERENCE', e.target.value)} 
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Product Image URL (PRODUCT_IMAGE)</label>
          <input 
            type="text" 
            value={data.PRODUCT_IMAGE} 
            onChange={(e) => onInputChange('PRODUCT_IMAGE', e.target.value)} 
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
            placeholder="./dior_files/PRODUCT_IMAGE"
          />
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Product Price (PRICE)</label>
            <input 
              type="text" 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Taxes (TAXES)</label>
            <input 
              type="text" 
      ...
      {/* Shipping Address */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-gray-800 border-b pb-2">Shipping Address (SHIPPING1-4)</h3>
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i}>
              ...
              <input 
                ...
                onChange={(e) => onInputChange(`SHIPPING_ADDRESS_${i}` as keyof DiorReceiptData, e.target.value)} 
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
      ...
      {/* Billing Address */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-gray-800 border-b pb-2">Billing Address (BILLING1-4)</h3>
        <div className="grid grid-cols-1 gap-3">
          {[1, 2, 3, 4].map((i) => (
            <div key={i}>
              ...
              <input 
                ...
                onChange={(e) => onInputChange(`BILLING_ADDRESS_${i}` as keyof DiorReceiptData, e.target.value)} 
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder={i === 1 ? "John Doe" : i === 2 ? "123 Luxury Avenue" : i === 3 ? "Paris 75001" : "France"}
              />
            </div>
