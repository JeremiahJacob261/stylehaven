...
export function AppleReceiptForm({ data, onInputChange }: AppleReceiptFormProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input 
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
            placeholder="/path/to/product-image.png"
          />
        </div>
      </div>
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i}>
              ...
              <input 
                ...
                onChange={(e) => onInputChange(`ADDRESS_LINE_${i}` as keyof AppleReceiptData, e.target.value)} 
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          ))}
      ...
      {/* Billing Information */}
      <div className="space-y-4">
        <h3 className="text-lg font-medium text-gray-800 border-b pb-2">Billing Information</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
          ...
          {[1, 2, 3, 4].map((i) => (
            <div key={i}>
              ...
              <input 
                ...
                onChange={(e) => onInputChange(`BILLING_ADDRESS_${i}` as keyof AppleReceiptData, e.target.value)} 
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
          ))}
