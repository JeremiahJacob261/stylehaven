...
import { GoatReceiptData } from '@/types/receipt-types';

interface GoatReceiptFormProps {
  data: GoatReceiptData;
  onInputChange: (field: keyof GoatReceiptData, value: string) => void;
}

export function GoatReceiptForm({ data, onInputChange }: GoatReceiptFormProps) {
  return (
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <input 
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            placeholder="Air Jordan 1 Mid SE 'Elephant Toe'"
          />
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
        ...
        <div>
          ...
          <input 
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
            placeholder="/goat/goat_files/product-image.jpg"
          />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 gap-3">
          {[1, 2, 3, 4].map((i) => (
            <div key={i}>
              ...
              <input 
                type="text" 
                value={data[`SHIPPING_ADDRESS_${i}` as keyof GoatReceiptData]} 
                onChange={(e) => onInputChange(`SHIPPING_ADDRESS_${i}` as keyof GoatReceiptData, e.target.value)} 
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
